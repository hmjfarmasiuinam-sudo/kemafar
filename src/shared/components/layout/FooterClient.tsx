 ...
 * Displays dynamic contact information from settings
 */
...
export function FooterClient({ contactSettings, siteName }: FooterClientProps) {
  ...
  const socialLinks = [
    {
      ...
      visible: !!contactSettings.socialMedia.facebook
    },
    {
      icon: InstagramIcon,
      label: 'Instagram',
      href: contactSettings.socialMedia.instagram || '#',
      visible: !!contactSettings.socialMedia.instagram
    },
    {
      icon: YoutubeIcon,
      label: 'YouTube',
      href: contactSettings.socialMedia.youtube || '#',
      visible: !!contactSettings.socialMedia.youtube
    },
    ...
    <footer className="bg-black text-white pt-24 pb-12 border-t border-gray-900">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          >
            <h2 className="text-3xl font-black tracking-tight mb-6">{siteName}</h2>
            <p className="text-gray-300 leading-relaxed mb-8 text-lg font-light">
              {contactSettings.footerDescription}
            </p>
