    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-12">
        {members.map((member, idx) => (
          ...
          >
            {/* Avatar */}
            <div className="relative w-20 h-20 flex-shrink-0 overflow-hidden rounded-full bg-gray-800 border-2 border-gray-700 group-hover:border-primary-400 transition-all duration-500">
              {member.photo ? (
                <Image
                  src={member.photo}
                  alt={member.name}
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-[30rem] h-[30rem] bg-primary-900/20 rounded-full blur-[100px] -z-10" />
        <div className="absolute bottom-1/4 right-1/4 w-[25rem] h-[25rem] bg-secondary-900/20 rounded-full blur-[100px] -z-10" />
      </div>

      {/* Core Team */}
      <section className="pb-20 md:pb-32 text-white">
